...
function array_insert(array_of_things, insertion_index, item_to_be_inserted = undefined) {
    ...
    return [
        ...array_of_things.slice(0, insertion_index),
        item_to_be_inserted,
        ...array_of_things.slice(insertion_index),
    ];
}
...
function object_sort(object_of_things) {
    ...
    return Object.keys(object_of_things)
        .sort()
        .reduce((r, k) => ((r[k] = object_of_things[k]), r), {});
}
