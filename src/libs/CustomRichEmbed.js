    ...
    constructor(options = {}, message = undefined) {
        ...
        this.author = message
            ? options.author !== undefined
                ? options.author
                : { iconURL: message.author.displayAvatarURL({ dynamic: true }), name: `@${message.author.tag}` }
            : options.author ?? null;
        ...
        this.footer = message
            ? options.footer !== undefined
                ? options.footer
                : { iconURL: `${client.user.displayAvatarURL({ dynamic: true })}`, text: `${message.cleanContent}` }
            : options.footer ?? null;
