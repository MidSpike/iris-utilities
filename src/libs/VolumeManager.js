...
class VolumeManager {
    ...
    async setVolume(volume_input=this.#fallback_volume, update_last_volume=true, clamp_volume=true) {
        if (this.guild.me.voice?.connection?.dispatcher?.setVolume) {
            ...
            this.guild.me.voice.connection.dispatcher.setVolume((await this.multiplier) * this.volume * guild_dispatcher_volume_ratio);
        }
        return this;
    }
