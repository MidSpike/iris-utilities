...
pub async fn info_ai_chat_channels(
    ctx: Context<'_>,
) -> Result<(), Error> {
...
pub async fn list_ai_chat_channels(
    ctx: Context<'_>,
) -> Result<(), Error> {
    let guild_id = ctx.guild_id().expect("There should be a guild in this context.");
...
pub async fn allow_ai_chat_channel(
    ctx: Context<'_>,
...
pub async fn disallow_ai_chat_channel(
    ctx: Context<'_>,
