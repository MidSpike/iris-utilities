...
module.exports = new DisBotCommand({
    ...
    async executor(Discord, client, message, opts = {}) {
        ...
        if (command_args.join('').length > 1) {
            // See if they left some feedback
            client.channels.cache
                .get(bot_central_feedback_channel_id)
                .send(
                    new CustomRichEmbed({
                        author: {
                ...
                .then(async () => {
                    ...
                    const support_guild_invite = await support_guild.channels.cache
