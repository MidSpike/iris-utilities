                ...
                fields:[
                    {
                        ...
                        value:`You can always run \`${discord_command} reset\` to reset this setting!`
                    }, {
                        name:'Information',
                        value:`When setting auto roles, make sure that I have \`ADMINISTRATOR\` permissions and that my role is placed above the roles you want me to add to the user.`
                    }
                ]
            }));
        }
