                    ...
                    new CustomRichEmbed(
                        {
                            ...
                            fields: [
                                ...
                                {
                                    name: `Example`,
                                    value: `The following will place / remove someone from timeout${'```'}\n${discord_command} @user#0001${'```'}`,
                                },
                                {
                                    name: `Example`,
                                    value: `The following will show the users in timeout${'```'}\n${discord_command} list${'```'}`,
                                },
                            ],
                        },
                        message,
            ...
            message.guild.members
                ...
                .then(async (guildMember) => {
                    ...
                    await client.$.guild_configs_manager.updateConfig(message.guild.id, {
                        users_in_timeout: users_in_timeout.includes(guildMember.id)
                            ? [...users_in_timeout.filter((user_id) => user_id !== guildMember.id)]
                            : [...users_in_timeout, guildMember.id],
                    });
