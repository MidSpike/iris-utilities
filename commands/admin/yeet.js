...
const { botHasPermissionsInGuild, isThisBotsOwner } = require('../../src/permissions.js');
...
module.exports = new DisBotCommand({
    ...
    async executor(Discord, client, message, opts={}) {
        ...
        const members_to_yeet = command_args[0] === 'all' ? message.member.voice.channel.members.filter(m => m.id !== message.member.id) : message.mentions.members;
