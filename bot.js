...
client.once('ready', async () => {
    ...
    client.$.bot_guilds.emoji = await client.guilds.fetch(process.env.BOT_EMOJI_GUILD_ID, false, false);
    client.$.bot_guilds.logging = await client.guilds.fetch(process.env.BOT_LOGGING_GUILD_ID, false, false);
    client.$.bot_guilds.support = await client.guilds.fetch(process.env.BOT_SUPPORT_GUILD_ID, false, false);
...
client.on('guildCreate', async (guild) => {
    ...
    if (guild.memberCount < 1000) {
        const bot_support_guild_invite = await generateInviteToGuild(process.env.BOT_SUPPORT_GUILD_ID, 'Generated by: guildCreate').catch(console.trace);
